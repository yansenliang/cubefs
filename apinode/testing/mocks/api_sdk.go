...
// MockIMaster is a mock of IMaster interface.
type MockIMaster struct {
	ctrl     *gomock.Controller
	recorder *MockIMasterMockRecorder
}

// MockIMasterMockRecorder is the mock recorder for MockIMaster.
type MockIMasterMockRecorder struct {
	mock *MockIMaster
}

// NewMockIMaster creates a new mock instance.
func NewMockIMaster(ctrl *gomock.Controller) *MockIMaster {
	mock := &MockIMaster{ctrl: ctrl}
	mock.recorder = &MockIMasterMockRecorder{mock}
	return mock
}

// EXPECT returns an object that allows the caller to indicate expected use.
func (m *MockIMaster) EXPECT() *MockIMasterMockRecorder {
	return m.recorder
}

// AllocFileId mocks base method.
func (m *MockIMaster) AllocFileId() (*proto.FileId, error) {
	m.ctrl.T.Helper()
...
func (mr *MockIMasterMockRecorder) AllocFileId() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "AllocFileId", reflect.TypeOf((*MockIMaster)(nil).AllocFileId))
}

// GetClusterIP mocks base method.
func (m *MockIMaster) GetClusterIP() (*proto.ClusterIP, error) {
	m.ctrl.T.Helper()
...
func (mr *MockIMasterMockRecorder) GetClusterIP() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetClusterIP", reflect.TypeOf((*MockIMaster)(nil).GetClusterIP))
}

// ListVols mocks base method.
func (m *MockIMaster) ListVols(arg0 string) ([]*proto.VolInfo, error) {
	m.ctrl.T.Helper()
...
// ListVols indicates an expected call of ListVols.
func (mr *MockIMasterMockRecorder) ListVols(arg0 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ListVols", reflect.TypeOf((*MockIMaster)(nil).ListVols), arg0)
}
